...
use App\Http\Controllers\Admin\DesignStickerController;
use App\Http\Controllers\Admin\SavedDesignController;
...
Route::group(
    ...
    function () {
        ...
        Route::prefix('websolla-db')->middleware(['auth', 'admin'])->group(function () {
            ...
            Route::resource('/design-stickers', DesignStickerController::class)->except(['show']);
            Route::resource('/saved-designs', SavedDesignController::class)->only(['index', 'show', 'destroy']);
            Route::resource('/cart-items', CartItemController::class)->only(['index', 'show', 'destroy']);
