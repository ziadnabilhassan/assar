...
<header class="header__section">
            ...
            <div class="header__topbar--inner d-flex align-items-center justify-content-between">
                <div class="header__shipping">
                    <ul class="header__shipping--wrapper d-flex">
                        <li class="header__shipping--text text-white">Welcome to brando online Store</li>
                        <li class="header__shipping--text text-white d-sm-2-none"><img
                                class="header__shipping--text__icon" src="{{ asset('website/assets/img/icon/bus.png') }}"
                                alt="bus-icon"> Track Your Order</li>
                        <li class="header__shipping--text text-white d-sm-2-none"><img
                                class="header__shipping--text__icon"
                                src="{{ asset('website/assets/img/icon/email.png') }}" alt="email-icon"> <a
                ...
                <div class="language__currency d-none d-lg-block">
                    <ul class="d-flex align-items-center">
                        <li class="language__currency--list">
                            <a class="language__switcher text-white" href="shop.php">
                                <img class="language__switcher--icon__img"
                                    src="{{ asset('website/assets/img/icon/language-icon.png') }}" alt="currency">
                                <span>{{ LaravelLocalization::getCurrentLocale() === 'en' ? 'English' : 'Arabic' }}</span>
                            ...
                            <div class="dropdown__language">
                                <ul>
                                    <li class="language__items"><a class="language__text" href="{{ LaravelLocalization::getLocalizedURL(LaravelLocalization::getCurrentLocale() === 'en' ? 'ar' : 'en') }}">
                                            {{ LaravelLocalization::getCurrentLocale() === 'en' ? 'Arabic' : 'English' }}</a>
                                    </li>
            ...
            <div class="main__header--inner position__relative d-flex justify-content-between align-items-center">
                ...
                <div class="main__logo">
                    <h1 class="main__logo--title"><a class="main__logo--link" href="{{ route('home') }}"><img
                                class="main__logo--img" src="{{ asset('website/assets/img/logo/nav-log.png') }}"
                                alt="logo-img"></a></h1>
                </div>
                <div class="header__search--widget header__sticky--none d-none d-lg-block">
                    <form class="d-flex header__search--form" action="{{ route('products') }}">
                        ...
                        <div class="header__search--box">
                            <label>
                                <input class="header__search--input" type="text"   placeholder="{{ __('main.search here') }}"
                        name="search" >
                            </label>
                      ...
                      <ul class="d-flex justify-content-end">
                            ...
                            <li class="header__account--items header__account2--items">
                                @auth
                                    <a class="header__account--btn" href="{{ route('profile.index') }}">
                                        ...
                                        <span class="visually-hidden">{{ __('main.profile') }}</span>
                                    </a>
                                @else
                                    <a class="header__account--btn" href="{{ route('login') }}">
                                        ...
                                        <span class="visually-hidden">{{ __('main.login') }}</span>
                                    </a>
                                @endauth
                            ...
                            <li class="header__account--items header__account2--items">
                                <a class="header__account--btn minicart__open--btn" href="javascript:void(0)"
                                    ...
                                    <span
                                        class="items__count style2 cart-count">{{ Cart::getContent()->count() }}</span>
                                </a>
                            </li>
                        </ul>
                </div>
                <div class="header__menu d-none header__sticky--block d-lg-block">
                    <nav class="header__menu--navigation">
                        <ul class="d-flex">
                            ...
                            <li class="header__menu--items mega__menu--items style3" style="position: relative">
                                <a class="header__menu--link" href="{{ route('products') }}">
                                    {{ __('main.categories') }}
                            ...
                            <li class="header__menu--items style3">
                                <a class="header__menu--link" href="{{ route('contacts') }}">
                                    {{ __('main.contact us') }}
                                </a>
                            </li>
                        </ul>
        ...
        <div class="container-fluid">
            <div
                ...
                <p class="header__discount--text"><img class="header__discount--icon__img"
                        src="{{ asset('website/assets/img/icon/lamp.png') }}" alt="lamp-img"> </p>
            </div>
        </div>
    </div>
        ...
        <div class="offcanvas__inner">
            <div class="offcanvas__logo">
                <a class="offcanvas__logo_link" href="{{ route('home') }}">
                    <img src="{{ asset('website/assets/img/logo/nav-log.png') }}" alt="Grocee Logo" width="158"
                        height="36">
                </a>
            ...
            <nav class="offcanvas__menu">
                <ul class="offcanvas__menu_ul">
                    ...
                    <li class="offcanvas__menu_li">
                        <a class="offcanvas__menu_item" href="{{ route('products') }}">
                            {{ __('main.products') }}
                        </a>
                    </li>
                    <li class="offcanvas__menu_li">
                    ...
                    <li class="offcanvas__menu_li">
                        <a class="offcanvas__menu_item" href="{{ route('about') }}">
                            {{ __('main.about us') }}
                        </a>
                    </li>
                    <li class="offcanvas__menu_li">
                        <a class="offcanvas__menu_item" href="{{ route('contacts') }}">
                            {{ __('main.contact us') }}
                        </a>
                    </li>
                </ul>
        ...
        <ul class="d-flex justify-content-between">
            <li class="offcanvas__stikcy--toolbar__list">
                <a class="offcanvas__stikcy--toolbar__btn" href="{{ route('home') }}">
                    ...
                    <span class="offcanvas__stikcy--toolbar__label">{{ __('main.home') }}</span>
                </a>
            </li>
            <li class="offcanvas__stikcy--toolbar__list">
                <a class="offcanvas__stikcy--toolbar__btn" href="{{ route('products') }}">
                    ...
                    <span class="offcanvas__stikcy--toolbar__label">{{ __('main.shop') }}</span>
                </a>
            </li>
            <li class="offcanvas__stikcy--toolbar__list ">
                <a class="offcanvas__stikcy--toolbar__btn search__open--btn" href="javascript:void(0)" data-offcanvas>
                    ...
                    <span class="offcanvas__stikcy--toolbar__label">{{ __('main.search') }}</span>
                </a>
            </li>
            <li class="offcanvas__stikcy--toolbar__list">
                <a class="offcanvas__stikcy--toolbar__btn minicart__open--btn" href="javascript:void(0)"
                    ...
                    <span class="offcanvas__stikcy--toolbar__label">{{ __('main.cart') }}</span>
                    <span class="items__count cart-count">{{ Cart::getContent()->count() }}</span>
                </a>
            </li>
            <li class="offcanvas__stikcy--toolbar__list">
                <a class="offcanvas__stikcy--toolbar__btn minicart__open--btn" href="{{ route('profile.index') }}"
                    data-offcanvas>
                    <span class="offcanvas__stikcy--toolbar__icon">
                        <svg xmlns="http://www.w3.org/2000/svg" width="26.51" height="23.443"
                            viewBox="0 0 512 512">
                    ...
                    <span class="offcanvas__stikcy--toolbar__label">{{ __('main.profile') }}</span>
                </a>
            </li>
        </ul>
    </div>
    ...
    <div class="offCanvas__minicart">
        <div class="minicart__header ">
            <div class="minicart__header--top d-flex justify-content-between align-items-center">
                <h2 class="minicart__title h3"> {{ __('main.shopping cart') }}</h2>
                <button class="minicart__close--btn btn-cart-close" aria-label="minicart close button" data-offcanvas>
                ...
                <div class="minicart__product--items d-flex">
                    <div class="minicart__thumb">
                        <a
                            ...
                            <img src="{{ asset($item->attributes->image) }}" alt="product-img"
                    ...
                    <div class="minicart__text">
                        ...
                        <span class="color__variant"><b>{{ __('main.color') }}:</b>
                            {{ $item->attributes->color[app()->getLocale()] }}</span>
                        <div class="minicart__price">
                            <span class="current__price">{{ __('main.currency') }} {{ $item->price }}</span>
                            @if ($item->attributes->old_price)
                                <span class="old__price">{{ __('main.currency') }}
                                    {{ $item->attributes->old_price }}</span>
                            @endif
                        </div>
                        <div class="minicart__text--footer d-flex align-items-center">
                            <button class="minicart__product--remove remove-item" data-id="{{ $item->id }}">
                                {{ __('main.remove') }}
                            </button>
                        </div>
                    </div>
        ...
        <div class="minicart__amount">
            <div class="minicart__amount_list d-flex justify-content-between">
                ...
                <span>
                    <b>{{ __('main.currency') }} {{ Cart::getTotal() }}</b>
                </span>
            </div>
        </div>

        <div class="minicart__button d-flex">
            <a class="primary__btn minicart__button--link w-100 text-center" href="{{ route('cart') }}">
                {{ __('main.shopping cart') }}
            </a>
        </div>
    </div>
    ...
    <div class="offCanvas__minicart">
        ...
        <div class="minicart__product">
            <div class="minicart__product--items d-flex">
                <div class="minicart__thumb">
                    <a href="product-details.php"><img src="{{ asset('website/assets/img/product/product1.png') }}"
                            alt="prduct-img"></a>
                </div>
                <div class="minicart__text">
            ...
            <div class="minicart__product--items d-flex">
                <div class="minicart__thumb">
                    <a href="product-details.php"><img src="{{ asset('website/assets/img/product/product2.png') }}"
                            alt="prduct-img"></a>
                </div>
                <div class="minicart__text">
        ...
        <div class="minicart__conditions text-center">
            ...
            <label class="minicart__conditions--label" for="accept">I agree with the <a
                    class="minicart__conditions--link" href="privacy-policy.php">Privacy and Policy</a></label>
        </div>
    ...
    <div class="predictive__search--box">
        <div class="predictive__search--box__inner">
            <h2 class="predictive__search--title">{{ __('main.search') }}</h2>
            <form class="predictive__search--form" action="{{ route('products') }}">
                <label>
                    <input class="predictive__search--input" placeholder="{{ __('main.search here') }}"
