...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">Edit Promo Code</h4>
            </div>
        </div>
    </div>
    <!-- breadcrumb -->
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <select name="discount_type" id="discount_type" class="form-control" required>
                            <option value="percentage" {{ $promocode->discount_type === 'percentage' ? 'selected' : '' }}>
                                Percentage</option>
                            <option value="fixed" {{ $promocode->discount_type === 'fixed' ? 'selected' : '' }}>Fixed
                            </option>
                        </select>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="number" name="max_uses" id="max_uses" class="form-control"
                            value="{{ old('max_uses', $promocode->max_uses) }}" required>
                    </div>
                </div>
                    ...
                    <div class="col-md-12 mb-3">
                        <div class="custom-checkbox custom-control">
                            <input type="checkbox" name="is_active" value="1" class="custom-control-input"
                                id="checkbox-1" {{ old('is_active', $promocode->is_active) ? 'checked' : '' }}>
                            <label for="checkbox-1" class="custom-control-label mt-1">Is Active</label>
                        </div>
                    </div>
                </div>

                <button type="submit" class="btn btn-outline-primary w-100 mt-4">Update Promo Code</button>
            </form>
        ...
        $(document).ready(function() {
            function updateDiscountValueMax() {
                ...
                if (discountType === 'percentage') {
                    ...
                    discountValue.attr('max', 999999);
                }
            }

            // Update max value when the page loads
