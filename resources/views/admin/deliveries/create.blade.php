...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">Create delivery</h4>
            </div>
        </div>
    </div>
    <!-- breadcrumb -->
        ...
        <div class="card-body">
            ...
            <form action="{{ route('deliveries.store') }}" method="post" enctype="multipart/form-data">
                ...
                <div class="row">
                    @foreach (LaravelLocalization::getSupportedLocales() as $localeCode => $properties)
                        <div class="col-6">
                            <div class="form-group">
                                <label for="overview">Delivery area {{ $localeCode }} <span
                    ...
                    <div class="col-12">
                        <div class="form-group">
                            <label for="overview">Cost <span class="font-weight-bold text-danger">*</span></label>
                            <input class="form-control" required placeholder="enter cost" name="cost">
                        </div>
                    </div>
                </div>
