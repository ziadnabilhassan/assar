...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">Contact (Social)</h4>
            </div>
        </div>
    </div>
    <!-- breadcrumb -->
                ...
                <div class="row">
                    <div class="col-6">
                        <div class="form-group">
                            ...
                            <input class="form-control" name="facebook" value="{{ $contact->facebook ?? '' }}">
                        </div>
                    </div>
                    <div class="col-6">
                        <div class="form-group">
                            <label for="twitter">Twitter</label>
                            <input class="form-control"name="twitter" id="twitter" value="{{ $contact->twitter ?? '' }}">
                        </div>
                    </div>
                    <div class="col-6">
                        <div class="form-group">
                    ...
                    <div class="col-6">
                        <div class="form-group">
                            ...
                            <input class="form-control" name="tiktok" id="tiktok" value="{{ $contact->tiktok ?? '' }}">
                        </div>
                    </div>
                </div>
