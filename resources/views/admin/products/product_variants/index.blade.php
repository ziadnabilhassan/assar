    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                ...
                <span class="text-muted mt-1 tx-13 mr-2 mb-0"> / Product Sizes </span>
            </div>
        </div>
    </div>
    <!-- breadcrumb -->
    ...
    <div class="row row-sm">
        @foreach ($variants as $variant)
            <div class="col-6 col-md-4">
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('product.variants.update') }}" method="post">
                            <div class="row">
                                <div class="col-12">
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" min="0" class="form-control" name="old_price"
                                ...
                                <div class="col-12">
                                    <div class="d-flex w-100 mt-2" style="gap: 10px">
        ...
        <div class="modal" id="delete" style="display: none;" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content modal-content-demo">
                    ...
                    <form action="{{ route('product.variants.delete') }}" method="post">
                ...
                <div class="modal-content modal-content-demo">
                    ...
                    <form action="{{ route('product.variants.store') }}" method="post" enctype="multipart/form-data">
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                <label for="overview">Size <span class="font-weight-bold text-danger">*</span></label>
                                <select name="size_id" class="form-control" required>
                                    @foreach ($sizes as $size)
                                        <option value="{{ $size->id }}">
                                            {{ $size->name }}
                            ...
                            <div class="form-group">
                                <label for="overview">Quantity <span class="font-weight-bold text-danger">*</span></label>
                                <input type="number" min="0" class="form-control" name="quantity" required>
                            </div>
                            <div class="form-group">
                                <label for="overview">Price <span class="font-weight-bold text-danger">*</span></label>
                                <input type="text" min="0" class="form-control" name="price" required>
                            </div>
                            <div class="form-group">
                                <label for="overview">Old Price</label>
                                <input type="text" min="0" class="form-control" name="old_price">
