    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                ...
                <span class="text-muted mt-1 tx-13 mr-2 mb-0"> / Categories List </span>
            </div>
        </div>
    </div>
    <!-- breadcrumb -->
@endsection
@section('content')
    <a class="btn d-block btn-outline-primary mb-3" href="{{ route('categories.create') }}">Add Category</a>
                            ...
                            <tbody>
                                @foreach ($categories as $index => $category)
                                    <tr>
                                        ...
                                        <td>{{ $category->categoryType?->title ?? '-' }}</td>
                                        <td>
