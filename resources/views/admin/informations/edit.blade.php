...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">Edit New</h4>
            </div>
        </div>
    </div>
    <!-- breadcrumb -->
        ...
        <div class="card-body">
            <form action="{{ route('informations.update', $information->id) }}" method="post"
                ...
                <div class="row">
                        ...
                        <div class="col-12">
                            <div class="form-group">
                                ...
                                <input class="form-control" required placeholder="enter Title"
                                    value="{{ $information->getTranslation('title', $localeCode) }}"
                    ...
                    <div class="col-12">
                        <div class="form-group">
                            <label for="overview">Url</label>
                            <input class="form-control" placeholder="enter Url" name="url"
