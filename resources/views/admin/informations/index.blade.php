...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto mr-2">Advertisings</h4>
                <span class="text-muted mt-1 tx-13 mr-2 mb-0">/</span>
                <span class="text-muted mt-1 tx-13 mr-2 mb-0">List</span>
            </div>
        </div>
    </div>
    <!-- breadcrumb -->
@endsection
@section('content')
    <a class="btn d-block btn-outline-primary mb-3" href="{{ route('informations.create') }}">Add New</a>
                        ...
                        <table id="example1" class="table key-buttons text-md-nowrap">
                            ...
                            <tbody>
                                @foreach ($informations as $index => $information)
                                    <tr>
                                        <td>{{ ++$index }}</td>
                                        <td style="width: 400px">{{ $information->title }}</td>
                                        <td>
                                            <div class="row" style="gap: 10px; width: 120px">
                                                ...
                                                <a class="modal-effect btn btn-danger employee-delete"
                                                    ...
                                                    data-toggle="modal" href="#delete" data-id="{{ $information->id }}">
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content modal-content-demo">
                    <div class="modal-header">
                        <h6 class="modal-title">Delete New</h6><button aria-label="Close" class="close"
                            data-dismiss="modal" type="button"><span aria-hidden="true">×</span></button>
                    </div>
                    <form action="{{ route('informations.destroy', 'delete') }}" method="post">
