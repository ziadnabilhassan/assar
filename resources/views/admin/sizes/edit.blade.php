...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">Edit Size</h4>
            </div>
        </div>
    </div>
    <!-- breadcrumb -->
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="form-group">
                            ...
                            <input class="form-control" required placeholder="enter name" value="{{ $size->size }}"
                                name="name">
                        </div>
                    </div>
                </div>
...
@section('js')
    ...
    <!--Internal  spectrum-sizepicker js -->
    <script src="{{ URL::asset('assets/plugins/spectrum-sizepicker/spectrum.js') }}"></script>
