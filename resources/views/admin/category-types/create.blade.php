...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">Create Category Type</h4>
            </div>
        </div>
    </div>
    <!-- breadcrumb -->
        ...
        <div class="card-body">
            ...
            <form action="{{ route('category-types.store') }}" method="post" enctype="multipart/form-data">
                    ...
                    @foreach (LaravelLocalization::getSupportedLocales() as $localeCode => $properties)
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <input class="form-control" required placeholder="enter Title"
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="form-group">
                            <label for="show">Show Products in Home Page</label>
                            <select name="show" id="show" required class="form-control">
