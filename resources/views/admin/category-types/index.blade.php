...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">Category Types </h4>
                <span class="text-muted mt-1 tx-13 mr-2 mb-0"> / Category Types List </span>
            </div>
        </div>
    </div>
    <!-- breadcrumb -->
@endsection
@section('content')
    <a class="btn d-block btn-outline-primary mb-3" href="{{ route('category-types.create') }}">Add Category Type</a>
                        ...
                        <table id="example1" class="table key-buttons text-md-nowrap">
                            <thead>
                                <tr>
                                    ...
                                    <th class="wd-15p border-bottom-0">Show Products</th>
                            ...
                            <tbody>
                                @foreach ($categories as $index => $category)
                                    <tr>
                                        ...
                                        <td>
                                            <img src="{{ asset($category->image) }}" alt="course image"
                                                style="height: 70px;">
                                        </td>
                                        <td>
                                            @if ($category->show)
                                                <span class="badge badge-info text-white">Show</span>
                                            @else
                                                <span class="badge badge-warning text-white">Hide</span>
                                            @endif
                                        </td>
                                        <td>
                                            <div class="row" style="gap: 10px; width: 120px">
                                                <a class="btn btn-primary employee-edit" style="padding: 5px 10px"
                                                    href="{{ route('category-types.edit', $category->id) }}">
                                                    <i class="fa fa-edit"></i>
                                                </a>
                                                <a class="modal-effect btn btn-danger employee-delete"
                                                    style="padding: 5px 10px" data-effect="effect-slide-in-bottom"
                                                    data-toggle="modal" href="#delete" data-id="{{ $category->id }}">
        ...
        <div class="modal" id="delete" style="display: none;" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content modal-content-demo">
                    ...
                    <form action="{{ route('category-types.destroy', 'delete') }}" method="post">
