    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                ...
                <span class="text-muted mt-1 tx-13 mr-2 mb-0"> / Brands List </span>
            </div>
        </div>
    </div>
    <!-- breadcrumb -->
@endsection
@section('content')
    <a class="btn d-block btn-outline-primary mb-3" href="{{ route('brands.create') }}">Add Brand</a>
                        ...
                        <table id="example1" class="table key-buttons text-md-nowrap">
                            ...
                            <tbody>
                                @foreach ($brands as $index => $brand)
                                    <tr>
                                        <td>{{ ++$index }}</td>
                                        <td style="width: 400px">{{ $brand->title }}</td>
                                        <td>
                                            <img src="{{ asset($brand->image) }}" alt="course image" style="height: 70px;">
                                        </td>
                                        <td>
                                            <div class="row" style="gap: 10px; width: 120px">
                                                ...
                                                @if ($brand->id != 0)
                                                    <a class="modal-effect btn btn-danger employee-delete"
                                                        ...
                                                        data-toggle="modal" href="#delete" data-id="{{ $brand->id }}">
        ...
        <div class="modal" id="delete" style="display: none;" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content modal-content-demo">
                    ...
                    <form action="{{ route('brands.destroy', 'delete') }}" method="post">
