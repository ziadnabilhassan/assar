    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                ...
                <span class="text-muted mt-1 tx-13 mr-2 mb-0"> / Reviews List </span>
            </div>
        </div>
    </div>
    <!-- breadcrumb -->
@endsection
@section('content')
    <a class="btn d-block btn-outline-primary mb-3" href="{{ route('reviews.create') }}">Add Review</a>
                        ...
                        <table id="example1" class="table key-buttons text-md-nowrap">
                            ...
                            <tbody>
                                @foreach ($reviews as $index => $review)
                                    <tr>
                                        <td>{{ ++$index }}</td>
                                        <td style="width: 400px">{{ $review->name }}</td>
                                        <td>
                                            <img src="{{ asset($review->image) }}" alt="course image"
                                                style="height: 70px;">
                                        </td>
                                        <td>
                                            <div class="row" style="gap: 10px; width: 120px">
                                                ...
                                                <a class="modal-effect btn btn-danger employee-delete"
                                                    ...
                                                    data-toggle="modal" href="#delete" data-id="{{ $review->id }}">
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content modal-content-demo">
                    <div class="modal-header">
                        <h6 class="modal-title">Delete Review</h6><button aria-label="Close" class="close"
                            data-dismiss="modal" type="button"><span aria-hidden="true">×</span></button>
                    </div>
                    <form action="{{ route('reviews.destroy', 'delete') }}" method="post">
