...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">Create Review</h4>
            </div>
        </div>
    </div>
    <!-- breadcrumb -->
            ...
            <form action="{{ route('reviews.store') }}" method="post" enctype="multipart/form-data">
                ...
                @foreach (LaravelLocalization::getSupportedLocales() as $localeCode => $properties)
                    <div class="form-group">
                        ...
                        <input class="form-control" required placeholder="enter name" name="name[{{ $localeCode }}]">
                    </div>
                    <div class="form-group">
                        <label for="overview">Review {{ $localeCode }} <span
                                class="font-weight-bold text-danger">*</span></label>
                        <textarea required class="form-control" placeholder="enter description" rows="5"
