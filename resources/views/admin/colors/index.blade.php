    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                ...
                <span class="text-muted mt-1 tx-13 mr-2 mb-0"> / Colors List </span>
            </div>
        </div>
    </div>
    <!-- breadcrumb -->
@endsection
@section('content')
    <a class="btn d-block btn-outline-primary mb-3" href="{{ route('colors.create') }}">Add Color</a>
                        ...
                        <table id="example1" class="table key-buttons text-md-nowrap">
                            <thead>
                                <tr>
                                    ...
                                    <th class="wd-15p border-bottom-0">Color EN</th>
                                    <th class="wd-15p border-bottom-0">Color AR</th>
                            ...
                            <tbody>
                                @foreach ($colors as $index => $color)
                                    <tr>
                                        <td>{{ ++$index }}</td>
                                        <td style="width: 400px">{{ $color->getTranslation('name', 'en') }}</td>
                                        <td style="width: 400px">{{ $color->getTranslation('name', 'ar') }}</td>
                                        <td>
                                            <div class="row" style="gap: 10px; width: 120px">
                                                ...
                                                <a class="modal-effect btn btn-danger employee-delete"
                                                    ...
                                                    data-toggle="modal" href="#delete" data-id="{{ $color->id }}">
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content modal-content-demo">
                    <div class="modal-header">
                        <h6 class="modal-title">Delete Color</h6><button aria-label="Close" class="close"
                            data-dismiss="modal" type="button"><span aria-hidden="true">×</span></button>
                    </div>
                    <form action="{{ route('colors.destroy', 'delete') }}" method="post">
