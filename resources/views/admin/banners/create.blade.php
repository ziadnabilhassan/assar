...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">Create Banner</h4>
            </div>
        </div>
    </div>
    <!-- breadcrumb -->
    ...
    <div class="card">
        <div class="card-body">
            ...
            <form action="{{ route('banners.store') }}" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <label for="overview">Url <span class="font-weight-bold text-danger">*</span></label>
                    <input class="form-control" required placeholder="enter url" name="url">
                </div>
