...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">Banners </h4>
                <span class="text-muted mt-1 tx-13 mr-2 mb-0"> / Banners List </span>
            </div>
        </div>
    </div>
    <!-- breadcrumb -->
@endsection
@section('content')
    <a class="btn d-block btn-outline-primary mb-3" href="{{ route('banners.create') }}">Add Banner</a>
    <!-- row opened -->
    <div class="row">
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="pro-img-box mb-0">
                            <img class="w-100" src="{{ asset($banner->image) }}" style="" alt="product-image">
                        </div>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content modal-content-demo">
                    <div class="modal-header">
                        <h6 class="modal-title">Delete banner</h6><button aria-label="Close" class="close"
